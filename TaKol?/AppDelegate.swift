...
//                 Override point for customization after application launch.
        if UserdefultsManger.shared.userData != nil && UserdefultsManger.shared.isLogedIn! {
            ...
            self.window?.rootViewController = UINavigationController(rootViewController: signInVC)
            self.window!.makeKeyAndVisible()
        }
